...
def fetch_extra_content_urls() -> List[str]:
    ...
    result.extend([("/ConsoleMode.tar.gz", "https://github.com/jackyangantelope/Downloader_MiSTer/releases/download/latest/ConsoleMode.tar.gz")])
    result.extend([("/install.sh", "https://github.com/jackyangantelope/Downloader_MiSTer/releases/download/latest/install.sh")])
